  ...
  renderHome = () => {
    ...
    return (
      <div>
        ...
        {authed && (
          <div>
            <Link className="button" to="/dashboard/your-office/skills">
              Skills
            </Link>
            <Link className="button" to="/dashboard/find/talent">
              Talents
            </Link>
        ...
        <ModalLogin show={showLogin} handleClose={this.handleClose} onAuth={this.handleAuth} />
        <ModalRegister show={showRegister} handleClose={this.handleClose} onReg={this.handleReg} />
      </div>
    );
    /* return (
      <div>
