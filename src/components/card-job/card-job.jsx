          ...
          <div class="job-box-header flexbox justify-space-between">
            ...
            <div class="panel panel-default">
              <div class="flexbox justify-space-between">
                ...
                <div class="award">
                  <span class="icon icon-badge-flat">
                    <span class="path1" />
                    <span class="path2" />
                    <span class="path3" />
                    <span class="path4" />
        ...
        {visible && (
          <div>
            <div class="caret-block">
              <span class="caret-top" />
            </div>
            <div class="panel panel-default job-box-details">
              <button class="btn btn-bg-transparent close-btn icon-btn">
              ...
              <div class="flexbox justify-space-between">
                <div class="about-block-wrapper">
                  <div class="photo-block">
                    <div class="flexbox justify-space-between">
                      <div class="award">
                        <span class="icon icon-badge-solid" />
                      </div>
                      <div class="job-box-photo bg-cover circul-shape" />
                      <div class="job-box-rate">
                        <span class="icon icon-star-full" />
                  ...
                  <div class="info-block">
                    <div class="title">$7,832 Total Spent</div>
                  </div>
                  <div class="info-block">
                    <div class="title">30 Samples / 20 jobs</div>
                  </div>
                  <div class="info-block">
                  ...
                  <div class="job-details-right-header flexbox">
                    <div class="likes flexbox">
                      ...
                      <ul class="likes-list list-unstyled">
                        <li class="like-item like-item--1 bg-cover circul-shape" />
                        <li class="like-item like-item--2 bg-cover circul-shape" />
                        <li class="like-item like-item--3 bg-cover circul-shape" />
                        <li class="like-item like-item--1 bg-cover circul-shape" />
                      </ul>
                    </div>
